...
%Pri interpretaciji upoštevamo časovne zamike izračunov posameznih celic: vir \cite{quantum_dot} %navaja zamik enega urinega cikla, vir \cite{a_novel_approach} pa $1.5$ cikla, razen za D celico %$1.25$ urinega cikla.
...
Implementacija po viru \cite{quantum_dot} potrebuje za obdelavo signala $1$ urin cikel, implementacija po viru \cite{a_novel_approach} pa $5$ urinih faz, kar je $1.25$ urinega cikla.\\
